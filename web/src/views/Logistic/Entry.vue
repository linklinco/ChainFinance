<template>
    ...
    <el-table :data="store.getTotal" stripe style="width: 100%;height:80vh">
        ...
        <el-table-column label="预约入库时间" prop="entry_time" sortable />
        ...
        <el-table-column align="center" label="操作" fixed="right">
            ...
            <template #default="scope">
                ...
                <el-button v-if="scope.row.status == '待入库'" size="small" type="primary"
                ...
                <el-button v-if="scope.row.status == '待入库'" size="small" type="danger"

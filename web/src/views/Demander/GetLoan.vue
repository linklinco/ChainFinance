<template>
    ...
    <el-dialog v-model="showAddDialog" center title="融资申请表" width="600">
        <el-form label-position="top" label-width="auto">
            <el-form-item label="已选择质押物:">
                <el-text class="mx-1" type="primary">{{ info.hash }}</el-text>
            </el-form-item>
            <el-form-item label="请选择金融企业:">
            ...
            <el-form-item label="请输入贷款额度(万元):">
                <el-input v-model="input" style="width: 600px" placeholder="请输入贷款额度" />
            </el-form-item>
            <el-form-item>
        ...
        <el-table-column align="center" label="操作" fixed="right">
            ...
            <template #default="scope">
                ...
                <el-button v-if="scope.row.status == '已生成仓单'" size="small" type="primary"
                    @click="handleShow(scope.row.goods_id)">申请融资</el-button>
...
const remoteMethod = (query) => {
    if (query !== '') {
        loading.value = true
        axios.get('/api/getAllBanks').then((data) => {
